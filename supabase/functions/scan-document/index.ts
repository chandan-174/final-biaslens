...
Common biases to detect: Confirmation Bias, Recency Bias, Anchoring Bias, Survivorship Bias, Sunk Cost Fallacy, Overconfidence Bias, Groupthink, Planning Fallacy, Availability Heuristic, Status Quo Bias, Framing Effect, Bandwagon Effect.

Be thorough but not overly aggressive — only flag genuine biases. Respond with valid JSON array only.`;
